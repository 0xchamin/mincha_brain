...
|---|---|---|---|---|
| Agents | **established** | Autonomous LLM agents: the four owned parts (prompt/switch/context/loop), structured output, micro agents inside deterministic code, state + pause/resume, humans as tool calls, self-tuning, **and scaffolding as expiring bets on model limits** | 3 | [`brain/topics/agents.md`](brain/topics/agents.md) |
...
| Evals | **established** | Evaluating agent/LLM pipelines: per-stage metrics, pass@k, pairwise comparison, QA gates, closed-loop self-tuning, **generator/evaluator separation and making subjective quality gradable** | 2 | [`brain/topics/evals.md`](brain/topics/evals.md) |
